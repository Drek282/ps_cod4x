CREATE TABLE `ps_map_data_cod4x` (
  `dataid` int unsigned NOT NULL default '0',
  `coalitionkills` smallint unsigned NOT NULL default '0',
  `allegiancekills` smallint unsigned NOT NULL default '0',
  `joinedcoalition` smallint unsigned NOT NULL default '0',
  `joinedallegiance` smallint unsigned NOT NULL default '0',
  `joinedspectator` smallint unsigned NOT NULL default '0',
  `coalitionwon` smallint unsigned NOT NULL default '0',
  `coalitionlost` smallint unsigned NOT NULL default '0',
  `allegiancewon` smallint unsigned NOT NULL default '0',
  `allegiancelost` smallint unsigned NOT NULL default '0',
  PRIMARY KEY  (`dataid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE utf8mb4_general_ci;
CREATE TABLE `ps_plr_data_cod4x` (
  `dataid` int unsigned NOT NULL default '0',
  `coalitionkills` smallint unsigned NOT NULL default '0',
  `allegiancekills` smallint unsigned NOT NULL default '0',
  `coalitiondeaths` smallint unsigned NOT NULL default '0',
  `allegiancedeaths` smallint unsigned NOT NULL default '0',
  `joinedcoalition` smallint unsigned NOT NULL default '0',
  `joinedallegiance` smallint unsigned NOT NULL default '0',
  `joinedspectator` smallint unsigned NOT NULL default '0',
  `coalitionwon` smallint unsigned NOT NULL default '0',
...
CREATE TABLE `ps_plr_maps_cod4x` (
  `dataid` int unsigned NOT NULL default '0',
  `coalitionkills` smallint unsigned NOT NULL default '0',
  `coalitiondeaths` smallint unsigned NOT NULL default '0',
  `allegiancekills` smallint unsigned NOT NULL default '0',
...
INSERT INTO `ps_config_events` (`id`, `gametype`, `modtype`, `eventname`, `alias`, `regex`, `idx`, `ignore`, `codefile`) 
    VALUES 
        (52,'cod4x','','cod4x_init','','/^InitGame:\\s*(.+)/',520,0,''),
        (53,'cod4x','','cod4x_shutdown','','/^ShutdownGame:/',530,0,''),
        (59,'cod4x','','cod4x_plrtrigger','','/^(\\w+);(.+)/',590,0,'');
